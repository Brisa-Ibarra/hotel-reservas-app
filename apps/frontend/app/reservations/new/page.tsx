    ...
    return (
        <div className="min-h-screen bg-[#F5F0E8] paper-grain">
            ...
            <div className="max-w-2xl mx-auto p-6 mt-10 flex flex-col gap-6 animate-fade-in-up">
                <div>
                    <h2 className="font-heading italic text-3xl text-[#1F3A1F]">Confirmar reserva</h2>
                ...
                <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-[#C4A35A]/20 overflow-hidden">
                    <div className="relative bg-gradient-to-r from-[#1F3A1F] to-[#2D4A2D] px-6 py-4 overflow-hidden">
                        <div className="absolute -right-8 -top-8 w-24 h-24 rounded-full bg-white/5 blur-xl" />
                        <h3 className="relative text-white font-heading italic text-lg flex items-center gap-2">
                            <Hotel size={20} />
                    ...
                    <div className="p-6 flex flex-col gap-2">
                        ...
                        <p className="text-[#1F3A1F] font-bold text-xl">
                            ${room?.price}{' '}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-[#C4A35A]/20 p-6 flex flex-col gap-4">
                    <h3 className="text-[#1F3A1F] font-heading italic text-lg flex items-center gap-2">
                        <span className="bg-[#1F3A1F]/10 p-1.5 rounded-lg">
                            <Calendar size={18} className="text-[#1F3A1F]" />
                        </span>
                        Seleccioná tus fechas
                    </h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col gap-1.5 input-underline">
                    ...
                    {nights > 0 && (
                        <div className="bg-[#F5F0E8] rounded-xl p-4 flex justify-between items-center animate-fade-in-up">
                            ...
                            <p className="text-2xl font-bold text-[#1F3A1F]">Total: ${total}</p>
                        </div>
                    )}
                </div>
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        className="btn-shine bg-[#1F3A1F] hover:bg-[#2D4A2D] active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 text-white px-4 py-3 rounded-xl font-medium transition-all w-full text-lg shadow-md shadow-[#1F3A1F]/20"
                    >
                        {loading ? 'Confirmando...' : 'Confirmar reserva'}
                    </button>
                    <button
                        onClick={() => router.push('/rooms')}
                        className="group bg-[#F5F0E8] hover:bg-[#E8E0D0] text-[#1F3A1F] border border-[#C4A35A] px-4 py-3 rounded-xl font-medium transition-all w-full flex items-center justify-center gap-2"
                    >
